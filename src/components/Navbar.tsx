        ...
        <nav className="sticky top-0 z-50 bg-blue-600/95 backdrop-blur-sm text-white shadow-lg transition-all duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <Link to="/" className="text-2xl font-bold tracking-wide hover:text-blue-100 transition duration-200 flex items-center gap-2">
                        🛍️ <span className="hidden sm:inline">TokoKita</span>
                    </Link>

                    {/* Menu Links */}
                    <div className="flex items-center space-x-6">
                        <Link to="/" className="hover:text-blue-200 font-medium transition duration-200">
                            Home
                        </Link>

                        {/* Link Keranjang dengan Animasi Badge */}
                        <Link to="/cart" className="relative group hover:text-blue-200 transition duration-200 flex items-center">
                        ...
                        {user ? (
                            ...
                            <div className="flex gap-3">
                                <Link to="/login" className="hover:text-blue-100 font-medium transition px-3 py-2">
                                    Login
                                </Link>
                                <Link to="/register" className="bg-white text-blue-600 hover:bg-blue-50 px-4 py-2 rounded-full text-sm font-bold shadow-md transition transform hover:scale-105">
                                    Register
                                </Link>
                            </div>
                        )}
