        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
              Belanja Hemat, <br />{" "}
              <span className="text-yellow-400">Gaya Maksimal!</span>
            </h1>
            <p className="text-lg text-blue-100 mb-8 max-w-lg mx-auto md:mx-0">
              Temukan koleksi terbaik dengan harga yang pas di kantong. Kualitas
              terjamin, pengiriman cepat ke seluruh Indonesia.
            </p>
            <button
              onClick={() =>
                document
        ...
        <div className="flex flex-col sm:flex-row justify-between items-end mb-8 border-b border-gray-200 pb-4 gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Pilihan terbaik untuk Anda hari ini
            </p>
          </div>
          <button
            onClick={fetchProducts}
        ...
        {products.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm border border-dashed border-gray-300">
            ...
            <p className="text-gray-500 mb-6">
              Database sepertinya masih kosong.
            </p>
            <button
              onClick={handleSeed}
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-5 flex flex-col grow">
                  <h3
                    className="text-lg font-bold text-gray-800 mb-1 group-hover:text-blue-600 transition truncate"
                    title={product.name}
                  >
                    {product.name}
                  </h3>
