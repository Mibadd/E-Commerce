...
export default function Cart() {
    ...
    if (cart.length === 0) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
                ...
                <p className="text-gray-500 mb-6">Wah, sepertinya Anda belum belanja apa-apa.</p>
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <h1 className="text-3xl font-bold text-gray-800 mb-8">Keranjang Belanja ({totalItems} Item)</h1>
